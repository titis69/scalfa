...
clear
# REPO    
    REPO="https://raw.githubusercontent.comtitis69/scalfa/main/"
...
clear
izinsc="https://github.comtitis69/permission/main/alfa"
# USERNAME
rm -f /usr/bin/user
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version $latest_version
    ...
    sudo curl -fsSL https://raw.githubusercontent.comtitis69/scalfa/main/config/nginx.conf -o /etc/nginx/nginx.conf
...
wget -q https://raw.githubusercontent.comtitis69/scalfa/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
wget -q -O /etc/default/dropbear https://raw.githubusercontent.comtitis69/scalfa/main/config/dropbear.conf
...
wget -q https://raw.githubusercontent.comtitis69/scalfa/main/udp-custom/udp-custom.sh
...
wget https://raw.githubusercontent.comtitis69/scalfa/main/config/openvpn && chmod +x openvpn && ./openvpn
...
# Ganti Banner
wget -O /etc/kyt.txt https://raw.githubusercontent.comtitis69/scalfa/main/files/issue.net
